...
export const ANTIBIOTIC_CATALOG: Record<string, AntibioticDef> = {
  ...
  amikacin: {
    ...
    canExtendedInfusion: false, extendedBonus: 0,
    nephrotoxic: true, nephroStressorRate: 0.019,
    cnsPermeability: 'poor', spectrum: 'anti_gram_neg',
  ...
  vancomycin: {
    ...
    canExtendedInfusion: false, extendedBonus: 0,
    nephrotoxic: true, nephroStressorRate: 0.015,
  ...
  colistin: {
    ...
    canExtendedInfusion: false, extendedBonus: 0,
    nephrotoxic: true, nephroStressorRate: 0.025,
    cnsPermeability: 'poor', spectrum: 'anti_gram_neg',
  ...
  amphotericin_b: {
    ...
    canExtendedInfusion: false, extendedBonus: 0,
    nephrotoxic: true, nephroStressorRate: 0.027,
    cnsPermeability: 'good', spectrum: 'anti_fungal',
